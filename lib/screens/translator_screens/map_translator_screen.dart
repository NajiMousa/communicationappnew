...
class MapTranslatorScreen extends StatefulWidget {
  const MapTranslatorScreen({Key? key}) : super(key: key);

  @override
  _MapTranslatorScreenState createState() => _MapTranslatorScreenState();
}

class _MapTranslatorScreenState extends State<MapTranslatorScreen> {
